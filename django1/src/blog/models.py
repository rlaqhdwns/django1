...
class Post(models.Model):
    ...
    #blank(기본값 False) : True값을 저장한 경우, 품객체를 통한 사용자 입력공간 (<input>) 제공 시, 해당 변수의 입력공간을 빈칸으로 허용
...
#ImageField를 사용할려면 Pillow모듈이 설치되있어야 함
...
class PostFile(models.Model):
    ...
    file = models.FileField('첨푸파일', upload_to = 'files/%Y/%m/%d')