...
SOCIAL_AUTH_GOOGLE_PLUS_KEY = '331495612485-r7h4mgc1mhhj6jldofsh2rjlmmoo63mq.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = 'qCqrqCt-N7JSHLX7-q8ZS99Z'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/2.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '7nw@0%k*63wmt3o=a17n589^@g7ge79m2f*x8awb_w+i!6cv2h'
...
INSTALLED_APPS = [
    ...
    'bookmark',#웹프로젝트에 bookmark어플리케이션이 존재하는 것을 등록
    'vote',#내가 추가적으로 만드는 어플리케이션 이름을 넣어준다.
    'customlogin',
    'blog',
    #pip install social-auth-app-dijango 명령어로 모듈이 설치되있어야 사용가능
    'social_django',
]
...
#클라이언트의 요청으로 지정하는 미디어파일(이미지, 첨부파일) 설정
#MEDIA_URL : URL주소로 파일 주소를 접근할 떄 사용하는 URL을 저장하는 변수
#127.0.0.1:8000/files/로 시작하는 경로는 미디어파일을 불러오는 것으로
#판단함
MEDIA_URL = '/files/'
